...
RemoveNodeNameVisitor::RemoveNodeNameVisitor( jagSG::NodePtr node )
  : Visitor( "RemoveNodeNameVisitor" )
...
RemoveNodeNameVisitor::RemoveNodeNameVisitor( const RemoveNodeNameVisitor& rhs )
  : Visitor( rhs )
...
void RemoveNodeNameVisitor::reset()
{
    JAG3D_TRACE( "reset()" );
